...
export const ClosedWonView: React.FC = () => {
  ...
  if (loading) {
    return <div className="prs-loading"><div className="loading-spinner" /><p>Loading closed won renewals...</p></div>;
  }
  if (error) {
    ...
    <div className="prs-renewal-view">
      ...
      <div className="prs-stats-row">
        <div className="prs-stat">
          ...
          <span className="prs-stat-label">Closed Won</span>
        </div>
        <div className="prs-stat">
          <DollarSign size={16} />
          <span className="prs-stat-value">{formatCurrency(totalWonValue)}</span>
          <span className="prs-stat-label">Total Won Value</span>
        </div>
      </div>
